...
export interface memosPluginInstance {
  name: "memos"; config: memosPluginConfig; client: memosClient;
  memory: memosClient["memory"]; skills: memosClient["skills"];
  identity: memosClient["identity"]; rag: memosClient["rag"];
  dreams: memosClient["dreams"]; snapshot: memosClient["snapshot"];
  vault: memosClient["vault"]; pipeline: memosClient["pipeline"];
  sharing: memosClient["sharing"]; inft: memosClient["inft"];
  attach<T extends memosAgentShape>(agent?: T): T & {
    memory: memosClient["memory"]; skills: T["skills"] & memosClient["skills"];
    identity: memosClient["identity"]; rag: memosClient["rag"];
    dreams: memosClient["dreams"]; snapshot: memosClient["snapshot"];
    vault: memosClient["vault"]; pipeline: memosClient["pipeline"];
    sharing: memosClient["sharing"]; inft: memosClient["inft"];
...
export declare function memosPlugin(config: memosPluginConfig): memosPluginInstance;
