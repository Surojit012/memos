    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <button style={{ fontSize: 13, fontFamily: 'Inter, system-ui, sans-serif', color: 'var(--text2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>
            Profile
          </button>
          ...
          >
            ...
            <span style={{ fontSize: 11, fontFamily: 'JetBrains Mono, Fira Code, monospace', color: '#ffffff' }}>
