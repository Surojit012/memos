"""Local filesystem Module loader for MemoryOS."""
...
from brain.memoryos.models.module import Module
from brain.memoryos.models.module_manifest import ModuleManifest
from brain.memoryos.modules.module_validator import ModuleValidator
...
class ModuleLoader:
    ...
    def _python_module_name(root: Path, module_id: str) -> str:
        ...
        return f"memoryos_module_{safe_module_id}_{digest}"
