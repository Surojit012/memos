"""Provider routing for Memos Reason."""
...
from brain.memos.reason.context_builder import ReasoningContext
    ...
    def invoke(self, context: ReasoningContext) -> ProviderResponse:
        ...
        if memory_lines or module_lines:
            ...
            answer = (
                ...
                f"Answer: Based on Memos context, the most relevant evidence is: {evidence}.\n"
            ...
            answer = (
                f"Question: {context.question}\n"
                "Answer: No cited Memos sources were available for this question.\n"
